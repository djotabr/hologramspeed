...
const MaxSpeedDisplay = document.getElementById("maxSpeedValue")
var useMetric = true;
...
window.addEventListener("message", function(ev) {
	...
	if (data.maxSpeed != undefined) {
		...
		var maxUnitSpeed = Math.floor(parseFloat(data.maxSpeed));
		var maxSpeedString = maxUnitSpeed.toString();

		

		
			MaxSpeedDisplay.innerText = maxSpeedString; 
